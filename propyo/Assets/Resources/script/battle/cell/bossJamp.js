...
//print("状態" + grounded);
//print("ポジ"+ transform.localPosition + "始点" + (transform.position + transform.up * 1) +"終点" + (transform.position - transform.up * 100) );
//
...
//if (col.gameObject.name != "floa"){//ぶつかったら切ってみる
//rigidbody2D.isKinematic = true;//off
//}
...
//print("ジャンプ");
	...
	GetComponent.<Rigidbody2D>().AddForce(Vector3.up * 200);//重さを20倍にしてる

}



function tgob(param){//itween用こんぷりト
